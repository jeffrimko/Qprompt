...
This project provides a Python 2.7/3.x library that allows the user to quickly create CLI prompts for user input. The main features of this library are:
  ...
  - User input can optionally be supplied from command-line arguments allowing for task runner like automation.
...
=== Input Automation
User input can be automated using command-line arguments.
...
The `stdin_auto` context manager will automatically pass command-line arguments to input functions:
