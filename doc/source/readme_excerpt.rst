...
This project provides a Python 3.8+ library that allows the user to
...
.. figure::
   https://raw.githubusercontent.com/jeffrimko/Qprompt/master/doc/demos/main_demo.gif
   :alt: Demo
...
Qprompt should run on any Python 3.8+ interpreter and uses some
...
here <https://pypi.org/project/qprompt/>`__ and can be installed with
