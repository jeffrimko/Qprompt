...
Additionally, menus can be searched with fzf by entering `/` at the prompt. This features uses the excellent `iterfzf library by dahlia <https://github.com/dahlia/iterfzf>`_.
